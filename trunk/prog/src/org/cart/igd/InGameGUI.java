...
public class InGameGUI extends GUI
{
	...
	public void loadImages() {
		texBush = Display.renderer
				.loadImage("data/images/buttons/bush_ico_big.png");
		texQuestLog = Display.renderer
				.loadImage("data/images/buttons/questlog_ico.png");

		for (int iItm = 0; iItm < texItemIco.length; iItm++) {
			texItemIco[iItm] = Display.renderer
					.loadImage("data/images/buttons/item_ico_0" + (iItm + 1)
							+ ".png");
		}

		for (int iAnm = 0; iAnm < texAnimalIco.length; iAnm++) {
			texAnimalIco[iAnm] = Display.renderer
					.loadImage("data/images/buttons/animal_ico_0" + (iAnm + 1)
							+ ".png");
		}
