...
public class UserInput implements KeyListener, MouseListener, MouseMotionListener
{
	...
	public void mousePressed(MouseEvent e)
	{
		...
		{
			Display.renderer.camera.startDrag(e.getPoint());
		}
	}
	...
	public void mouseClicked(MouseEvent e)
	{
		...
		{
			Display.renderer.camera.resetRotation();
		}
	}
	...
	{
		updateMousePos(e.getX(), e.getY());
		if(Display.renderer.camera!=null)
			Display.renderer.camera.mouseMove(e.getPoint());
	}
	...
	public void mouseDragged(MouseEvent e)
	{
		...
		if(SwingUtilities.isLeftMouseButton(e))
		{
			Display.renderer.camera.drag(e.getPoint());
		}
	}
